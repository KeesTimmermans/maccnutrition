    ...
    <div className="fixed inset-0 z-50 bg-background flex items-center justify-center p-6">
      <div className="w-full max-w-sm space-y-6">
        <div className="space-y-2">
          <h1 className="text-xl font-bold text-foreground">Updated Policies</h1>
          <p className="text-sm text-muted-foreground">
            Our Privacy Policy and Terms have been updated (v{PRIVACY_POLICY_VERSION}). Please review
            and accept to continue using MacNutrition.
          </p>
        </div>
        ...
        <Button
          ...
          size="lg"
          className="w-full"
          disabled={!acceptedTerms || !acceptedHealth || saving}
