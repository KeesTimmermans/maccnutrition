...
import { Trophy, Calendar, TrendingUp, Droplets, Plus, Settings } from "lucide-react";
import { useAuth } from "@/hooks/useAuth";
import { getUserBaseline } from "@/lib/userService";
import { getActiveCompPrep, getCheckins } from "@/lib/competitionPrep/service";
...
import { deactivateCompPrep } from "@/lib/competitionPrep/service";

const CompetitionPrepTab = () => {
    ...
    return (
      <div className="space-y-6 pt-4">
        <div className="text-center space-y-4">
          ...
          <h2 className="text-xl font-bold text-foreground">Competition Prep Mode</h2>
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-semibold text-foreground">{eventLabel} · {prep.division}</p>
      ...
      <Card className="bg-primary/5 border-primary/20">
        <CardContent className="pt-4 pb-4 text-center">
          <div className="flex items-center justify-center gap-2 mb-1">
            ...
            <span className="text-sm text-muted-foreground">Event Countdown</span>
          </div>
...
export default CompetitionPrepTab;
